...
・著作物とは、「思想又は感情」を「創作的」に「表現」した「文芸・学術・美術・音楽」の範囲に属するもの
・著作権者ではない第三者の、著作物の複製や翻案を止める
・実質的に同一である場合も含む
・単なる思想やアイデア、事実が同一なだけでは著作物の複製や翻案に当たらない
・「創作的」の部分に関して、厳密な独創性が出ている必要はなく、作者の個性が出ていればよい
・換言すると、作者の個性が出る程度に選択の幅があり、ありふれた表現でなければよい
・例：小説、音楽、舞踊、絵画、建築、地図や学術的図面や模型、映画、写真、プログラム
